					...
					<div class="course<?php if($sponsored == true) { echo ' sponsored'; } ?>">
						<?php if($sponsored == true) { ?><div class="ad-note">golfmix ad</div><?php } ?>
						<div class="course-image">
							<img src="<?php echo $image; ?>" alt="" border="0" />
							<?php if($recent['total'] > 0 && $turn_flickr_off == '') { ?><a href="<?php echo $puri; ?>" target="_blank"><div class="flickr_attribution"></div></a><?php } ?>
						</div>
						...
						<div class="course-ratings">
							...
							<?php } else { echo '<a href="'.get_permalink().'" class="rate-first" style="float:right;font-size: 11px;">Be the first to review this course!</a>'; } ?>
							<div class="clear"></div>						
						</div>
						<div class="clear"></div>						
					</div>