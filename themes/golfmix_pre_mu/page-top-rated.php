...
get_header(); ?>
		...
		<div id="content">
			...
			<h2>Arizona's Top Rated Golf Courses by the golfmix community</h2>
			...
			$('#topcourses_select_big, #topcourses_city').change(function() {
					  ...
					  data: "ajax=1&distance=500&limit=18&per=18&style=page&sortby="+sortby,
			...
			<div id="top-courses-list-big">
				<?php 
				include(get_bloginfo('template_url').'/top_rated_xml.php?ajax=1&distance=500&limit=18&per=18&style=page&sortby='.$rand); 
				?>
			</div>
