    	  ...
    	  <div class="content-data">
			...
			<div class="tab-main" style="width: auto; float: right;">
				<ul>
					...
					<li><a href="http://gdata.youtube.com/feeds/users/WMPhoenixOpen/uploads?alt=json-in-script&callback=showMyVideos2&max-results=32" class="<?php if($_REQUEST['playlist']=='wmpo') { echo 'active'; } ?>"><span>WMPO</span></a></li>
