	...
	<div id="featured-top">
		<div id="featured-bestof">
			...
			$('#topcourses_select_big').change(function() {
					  ...
					  data: "ajax=1&distance=500&limit=10&per=10&style=featured&sortby="+sortby,
			...
			<div id="best-of-list">
				<?php 
				include(get_bloginfo('template_url').'/top_rated_xml.php?ajax=1&distance=500&limit=10&per=10&style=featured&sortby='.$rand); 
