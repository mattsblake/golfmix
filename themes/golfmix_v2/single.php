		...
		<!--content-->
			...
			<div id="left-col" itemscope itemtype="http://schema.org/GolfCourse">
				...
				<div class="course-details">
					...
					<?php 
					global $featured_course, $featured_twitter, $featured_facebook, $featured_foursquare, $specials;
					...
					$specials = get_post_meta(get_the_ID(), 'specials', 1);
					...
					<iframe src="http://www.facebook.com/plugins/like.php?href=<?php the_permalink(); ?>&amp;layout=button_count&amp;show_faces=false&amp;width=80&amp;action=like&amp;font=arial&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:80px; height:20px;" allowTransparency="true" class="fb-like"></iframe>
					...
					<ul class="course-info">
						...
						<li class="website"><a href="http://<?php echo $c_site; ?>" target="_new" itemprop="url"><?php echo $c_site; ?></a></li>
							...
							<?php $turn_off_overseeding = false; if($c_overseeding && $turn_off_overseeding !== true) { ?>
						...
						<div id="featured-photos" <?php if($featured_course=='yes' || $turn_on == '') { echo 'class="big"'; } ?>>				
							<?php if($specials) { ?>
							<div class="specials">
								<strong>Special Offer:</strong> <?php echo $specials; ?>
							</div>	
							<?php } ?>
							...
							if ( empty($images) ) {
								...
								foreach ( $images as $attachment_id => $attachment ) {
									...
									if($pcount < 4 ) {
									?>
												<div id="photo-<?php echo $pcount; ?>" class="photo"><img <?php if($pcount == 1) { echo 'itemprop="photo"'; }?> src="<?php echo $image_img_tag[0]; ?>" alt="<?php the_title(); ?>"/>
												</div>	
							<?php
									}
								}
							...
							foreach ($recent['photo'] as $photo) {
								...
								if($pcount < 4 ) {
									...
									$pimage = 'http://farm'.$pfarm.'.static.flickr.com/'.$pserver.'/'.$pid.'_'.$psecret.'_z.jpg';

									download_flickr_images_locally($pid,$ptitle,$pimage,get_the_ID());
									?>
												<div id="photo-<?php echo $pcount; ?>" class="photo"><img <?php if($pcount == 1) { echo 'itemprop="photo"'; }?> src="<?php echo $pimage; ?>" alt="<?php echo $ptitle; ?>"/>
							...
							<?php if($tee_time_link) { ?><a href="<?php echo $tee_time_link; ?>" class="book-tee-time" target="_new">Book a Tee Time!</a><?php } ?>
                             ...
                             <br clear="all" />
								...
								<div class="quick-fact-box">
									<a href="#" class="quick-fact">The GM's Corner</a>
