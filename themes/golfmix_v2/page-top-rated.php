...
get_header(); ?>
		...
		<div id="content">
			...
			$('#topcourses_select_big, #topcourses_city').change(function() {
					  ...
					  data: "ajax=1&market=<?php echo $market_coverage; ?>&lat=<?php echo $market_lat; ?>&lon=<?php echo $market_lon; ?>&distance=<?php echo $market_distance; ?>&limit=10&per=10&style=page&year=2012&sortby="+sortby,
			...
			<div id="top-courses-list-big">
				<?php 
				echo print_top_courses(get_bloginfo('template_url').'/top_rated_xml.php?ajax=1&market='.$market_coverage.'&lat='.$market_lat.'&lon='.$market_lon.'&distance='.$market_distance.'&limit=10&per=10&style=page&year=2012&sortby='.$rand); 
				?>
			</div>
