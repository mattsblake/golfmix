...
<div class="livesearchpopup">
     <div class="box">
     <img class="spiegel" src="<?php print get_bloginfo('wpurl') ?>/wp-content/plugins/live-search-popup/searchspiegel.png" alt="" />

     <form name="ls_form" class="form" id="searchform" method="get" action="<?php print get_bloginfo('wpurl')?>">
       <img class="left" src="<?php print get_bloginfo('wpurl') ?>/wp-content/plugins/live-search-popup/searchleft.png" alt=""/>
       <div class="editbox"><input class="edit" type="text" name="s" id="s" /></div>
       <input type="image" value="Search" class="lupe" src="<?php print get_bloginfo('wpurl') ?>/wp-content/plugins/live-search-popup/searchlupe.png" alt="" title="Click to view the result page."/>
     </form>
<?php
