...
' . $cmte . '
	...
	function init_options_map() 
	{
		$opnames = array(
			...
			'DEF_ENDBKGCOLOR', 'DEF_CUSTOMCOLORS', 'DEF_TITLEBACKCOLOR'
		);
	...
	{	
	   ...
	   for ($x = 0; $x < 8; $x++)
       {
      	   ...
      	   {
      	       if ($firstRow == FALSE)
      	         $rowStr .= "<tr><td colspan='2' style='border-bottom:1px solid;" . $defLineColor . ";'></td></tr>";     
            
      	       $rowStr .= "<tr><th class='easyReviewRow' style='width:100%;"
      	       		 . $defBkgColor . $defCatColor . "'>".$chartConfig[$keyTitle]."</th>"	                      
      	               . "<td class='easyReviewRow' style='white-space:nowrap;" . $defBkgColor . "'>";
      ...
      if ($firstRow == false && $chartConfig['overall'] == true)
       {
           ...
           $output .= "<div class='easyReviewConclude' style='" . $defEndLineColor . "'><table class='easyReviewTable'  border='0' style='text-align:center;' frame='box' align='center' bgcolor='FFFFFF'>";
           $output .= "<tr><th class='easyReviewRow' style='width:100%;" 
           		  . $defEndBkgColor . $defCatColor . "'>Overall</th>"
                   . "<td class='easyReviewRow' style='white-space:nowrap;" . $defEndBkgColor . "'>";	           
