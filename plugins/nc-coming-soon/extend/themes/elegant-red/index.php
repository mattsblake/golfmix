    ...
    <?php endif; ?>
        ...
        <body>
            ...
            <div id="main-container">
                ...
                <?php if(get_option_nc_cs_top('module_message') == 'Enable'): ?>
                    <div class="panel">
                    <?php echo nc_cs_message(); ?>
                    </div>
                <?php endif; ?>

                <?php if(get_option_nc_cs_top('module_countdown') == 'Enable'): ?>
                    <div class="panel countdown-fix">
                        <?php echo nc_cs_countdown(); ?>
                    </div>
                <?php endif; ?>

                <?php if(get_option_nc_cs_top('module_progress_bar') == 'Enable'): ?>
                    <div class="panel countdown-fix">
                    <?php echo nc_cs_progress(); ?>
                    </div>
                <?php endif; ?>

                <?php if(get_option_nc_cs_top('module_subscribe') == 'Enable'): ?>
                    <div class="panel countdown-fix">
                    <?php echo nc_cs_email(); ?>
                    </div>
                <?php endif; ?>

                <?php if(get_option_nc_cs_top('module_twitter_feed') == 'Enable'): ?>
                    <div class="panel countdown-fix">
...
<?php die(); ?>
        ...
        <?php echo nc_cs_logo(); ?>
                                    ...
                                    <div id="container" class="clearfix">
                                        ...
                                        <div class="<?php if (get_option_nc_cs_top('module_message') == 'Enable' && get_option_nc_cs_top('module_countdown') == 'Enable') {
                                        echo 'half';
                                    } else {
                                        echo 'message-fix';
                                    } ?>">
...
<?php echo nc_cs_countdown(); ?>
                            ...
                            <div class="<?php if (get_option_nc_cs_top('module_twitter_feed') == 'Enable' && get_option_nc_cs_top('module_subscribe') == 'Enable') {
                                        echo 'half';
                                    } ?>">
                                <div class="content">
<?php echo nc_cs_twitter_feed(1); ?>
