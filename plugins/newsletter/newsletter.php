...
function wpnewsletter_show_optin_form() {	
	...
	?>
		<h2>The volume around golf courses in Arizona is about to get a whole lot louder.</h2> 
		<h4> Sign up to raise your voice when the movement starts.</h4> 	
	
		<form action="" method="post">
			
				
				<tr>
					<td><input  type="text" onKeyPress="checkEnter(event)" value="email@domain.com" name="wpnewsletter_email" id="wpnewsletter_email"  /></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
				</tr>
...
function wpnewsletter_show_optin_form2() {	

	
	?>
			<form action="" method="post">
			
            	<?php echo stripslashes(get_option('wpnewsletter_form_header')) ;?>
               <tr>
					<td><input  type="text" onKeyPress="checkEnter(event)" value="email@domain.com" name="wpnewsletter_email" id="wpnewsletter_email" /></td>
				</tr>
				<tr>
			...
			. "Content-Type: text/plain; charset=\"" . get_option('blog_charset') . "\"\n";
				...
				if ($wpdb->query($selectqry)) {
					...
					if (mail($email,$subject,$message, $header)) {
						...
						<p>Invite at least <strong>3</strong> friends using the link below. The more friends you invite, the sooner you'll get access!</p>
						<p>To share with your friends, click "Share" and "Tweet":</p>
						<a name="fb_share" type="button" 
						   share_url="<?php echo $url; ?>" style="margin-top:-3px;margin-right:10px;">Share</a> 
						<script src="http://static.ak.fbcdn.net/connect.php/js/FB.Share" type="text/javascript">
						</script>
						<iframe allowtransparency="true" frameborder="0" scrolling="no" tabindex="0" class="twitter-share-button twitter-count-none" src="http://platform0.twitter.com/widgets/tweet_button.html?_=1295910580430&amp;count=none&amp;lang=en&amp;related=golfmix&amp;text=%40golfmix%20is%20about%20to%20change%20golf%20in%20AZ!%20Join%20me%20at%20&amp;url=<?php echo $url; ?>" style="width: 55px; height: 20px; " title="Twitter For Websites: Tweet Button"></iframe>
						<script src="http://platform.twitter.com/widgets.js" type="text/javascript"></script>
						<p style="margin:10px 0">Or copy and paste the following link to share wherever you want!</p>
						<input id="code" name="code" style="width:370px;float:none;margin:0 auto;" type="text" value="<?php echo $url; ?>">
